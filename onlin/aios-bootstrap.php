 ...
 */
$GLOBALS['aiowps_firewall_rules_path'] = __DIR__.'/files/aios/firewall-rules/';

$GLOBALS['aiowps_firewall_data'] = array(
	'ABSPATH' => '/home/villamart.in/public_html/online/',
);

// Begin AIOWPSEC Firewall
if (file_exists(__DIR__.'/lgtapps/lgtapp/all-in-one-wp-security-and-firewall/classes/firewall/wp-security-firewall.php')) {
	include_once(__DIR__.'/lgtapps/lgtapp/all-in-one-wp-security-and-firewall/classes/firewall/wp-security-firewall.php');
}
