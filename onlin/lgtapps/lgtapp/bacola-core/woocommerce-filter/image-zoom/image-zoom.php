<?php
if(get_theme_mod('bacola_single_image_zoom') == 1 || bacola_ft() == 'imgzoom'){
	
/*************************************************
## Scripts
*************************************************/
function bacola_image_zoom_scripts() {
...
add_action( 'wp_enqueue_scripts', 'bacola_image_zoom_scripts' );
...
function bacola_image_zoom_setup() {
	add_theme_support( 'wc-product-gallery-zoom' );
}
add_action( 'after_setup_theme', 'bacola_image_zoom_setup' );
