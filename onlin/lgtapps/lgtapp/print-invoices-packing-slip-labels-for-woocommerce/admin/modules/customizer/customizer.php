	...
	{         
        ...
        {	
        	...
        	*/
            ...
            $order_line_metas = $order_item->get_formatted_meta_data( ' ', true );
            
          	foreach($order_line_metas AS $meta=> $Option_value){
          	    
//      	      echo 	 str_replace("_", '', $Option_value->display_key);
//          		echo $Option_value->display_value;
            		
            $villaordermeta .=  str_replace("_", '', $Option_value->display_key).': ' . $Option_value->display_value;
...
//          	foreach($formatted_meta_data AS $meta){
          ...
          foreach($order_line_metas as $meta)
            {
