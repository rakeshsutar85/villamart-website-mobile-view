...
.wfte_doc_title{ color:#2c8214; font-size:30px; font-weight:bold; height:auto; width:100%; line-height:22px;text-transform: uppercase;}
...
.wfte_product_table .wfte_product_table_body tr td {text-transform: uppercase !important;font-size: 14px; font-weight: 600 !important;line-height: 20px;}


.wfte_product_table .wfte_product_table_body tr td small {text-transform: uppercase;font-size: 12px !important; font-weight:500  !important;;line-height:18px !important;}
.wfte_product_table .wfte_product_table_body tr td p{font-size: 12px !important; font-weight:400 !important;line-height:14px !important;}
    ...
    <div class="wfte_row wfte_padding_left_right clearfix">       
        <div class="wfte_col-7 float_left">
            ...
            <div class="wfte_invoice_data">
                ...
                <div class="wfte_order_date wfte_template_element" data-order_date-format="d-m-Y" data-hover-id="order_date">
