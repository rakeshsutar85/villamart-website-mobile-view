...
update_option('wcpa_activation_license_key', 'raz0r');
...
if (defined('WCPA_VERSION')) {//to check free version already running
    ...
    if (get_option('wcpa_activation_license_status') != 'valid') {
        update_option('wcpa_activation_license_status', 'valid');
        update_option('wcpa_activation_license_key', '123456-123456-123456-123456');
    }
