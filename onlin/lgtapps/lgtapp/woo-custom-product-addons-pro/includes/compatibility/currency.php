...
class Currency
{
    public function __construct()
    {
        ...
        add_filter('wcpa_currency_before_set_product_price', array($this, 'before_set_product_price'), 10, 2);
     ...
     * @return mixed|void
     */
    static function cartSetPrice($priceConverted, $originalPrice)
    {
        return apply_filters('wcpa_currency_before_set_product_price', $priceConverted, $originalPrice);
    }
//
...
//    }
    ...
    public function before_set_product_price($priceConverted, $originalPrice)
    {
