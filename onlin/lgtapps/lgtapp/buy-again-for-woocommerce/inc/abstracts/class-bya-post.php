...
if ( ! class_exists( 'BYA_Post' ) ) {

	/**
	 * BYA_Post Class.
	 */
	abstract class BYA_Post {
		...
		public function has_status( $status ) {
			...
			if ( ( is_array( $status ) && in_array( $current_status, $status ) ) || $current_status == $status ) {
				return true;
			}
		...
		protected function load_metadata() {
			...
			if ( ! bya_check_is_array( $meta_data_array ) ) {
