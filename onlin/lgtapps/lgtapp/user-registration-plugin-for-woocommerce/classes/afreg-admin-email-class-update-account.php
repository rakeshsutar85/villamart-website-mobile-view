...
if ( !class_exists( 'Addify_Registration_Fields_Admin_Email_Update_Account' ) ) { 
	...
	class Addify_Registration_Fields_Admin_Email_Update_Account extends WC_Email {
		...
		public function __construct() { 
			...
			$this->template_html  = 'templates/emails/afreg-update-user-email-admin.php'; // HTML template path
			$this->template_plain = 'templates/emails/plain/afreg-update-user-email-admin.php'; // Plain template path
