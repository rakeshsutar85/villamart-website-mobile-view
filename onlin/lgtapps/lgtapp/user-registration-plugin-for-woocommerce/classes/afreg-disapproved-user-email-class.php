...
if ( !class_exists( 'Addify_Registration_Fields_Disapproved_User_Email' ) ) { 
	...
	class Addify_Registration_Fields_Disapproved_User_Email extends WC_Email {
		...
		public function __construct() { 
			...
			$this->template_html  = 'templates/emails/afreg-disapproved-user-email-user.php'; // HTML template path
			$this->template_plain = 'templates/emails/plain/afreg-disapproved-user-email-user.php'; // Plain template path
