...
if ( !class_exists( 'Addify_Registration_Fields_Admin_Email' ) ) { 
	...
	class Addify_Registration_Fields_Admin_Email extends WC_Email {
		...
		public function __construct() { 
			...
			$this->template_html  = 'templates/emails/afreg-new-user-email-admin.php'; // HTML template path
			$this->template_plain = 'templates/emails/plain/afreg-new-user-email-admin.php'; // Plain template path
