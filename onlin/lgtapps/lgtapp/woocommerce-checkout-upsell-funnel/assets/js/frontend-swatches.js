...
viwcuf_get_variation.prototype.show_variation = function (self, variation, form) {
    ...
    if (variation) {
        ...
        if (variation.viwcuf_price_html) {
            form.find('.single_variation').removeClass('vi-wcuf-disable').html('<div class ="woocommerce-variation-price" >' + variation.viwcuf_price_html + '</div>');
