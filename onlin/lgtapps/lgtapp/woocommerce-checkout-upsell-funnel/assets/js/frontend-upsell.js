...
jQuery( function( $ ) {
    $(document).ready(function () {
        ...
        viwcuf_upsell_funnel.wc_ajax_url = viwcuf_frontend_us_params.wc_ajax_url;
        viwcuf_upsell_funnel.checkout_url = viwcuf_frontend_us_params.checkout_url;
        viwcuf_upsell_funnel.is_redirect_page = viwcuf_frontend_us_params.is_redirect_page;
        viwcuf_upsell_funnel.is_popup = viwcuf_frontend_us_params.is_popup;
        viwcuf_upsell_funnel.position = viwcuf_frontend_us_params.position;
        viwcuf_upsell_funnel.limit_rows = viwcuf_frontend_us_params.limit_rows;
        viwcuf_upsell_funnel.pd_hide_after_atc = viwcuf_frontend_us_params.pd_hide_after_atc;
        viwcuf_upsell_funnel.i18n_unavailable_text = viwcuf_frontend_us_params.i18n_unavailable_text || 'Sorry, this product is unavailable. Please choose a different combination.';
        viwcuf_upsell_funnel.i18n_make_a_selection_text = viwcuf_frontend_us_params.i18n_make_a_selection_text || 'Please select some product options before adding {product_name} to your cart.';
        viwcuf_upsell_funnel.i18n_quantity_error = viwcuf_frontend_us_params.i18n_quantity_error || 'The maximum number of {product_name} quantity is {pd_limit_quantity}';
        viwcuf_upsell_funnel.$wrap = $('.viwcuf-checkout-funnel-container');
        viwcuf_upsell_funnel.$checkout_form = $('form.checkout');
    ...
    var viwcuf_upsell_funnel = {
        ...
        init_events:function (){
            ...
            self.$wrap.on('click', '.vi-wcuf-us-product-not-redirect .vi-wcuf-us-product-top, .vi-wcuf-us-product-not-redirect .vi-wcuf-us-product-desc', function (e) {
                ...
                e.preventDefault();
                let product = $(this).closest('.vi-wcuf-us-product');
                if (product.is('.vi-wcuf-us-product-2')) {
        ...
        design: function (only_design = false) {
            ...
            if (wrap.hasClass('viwcuf-checkout-funnel-container-scroll')) {
                ...
                if (limit_rows && limit_rows > 0) {
                    ...
                    limit_height = limit_height * limit_rows;
                    wrap.find('.vi-wcuf-us-shortcode-content-2').css({'max-height': limit_height + 'px'});
                }
                wrap.find('.vi-wcuf-us-shortcode-products-wrap').parent().addClass('vi-wcuf-us-shortcode-content-2-scroll');
            } else {
            ...
            wrap.find('.vi-wcuf-us-product-2 .vi-wcuf-us-cart-item-info').each(function () {
        ...
        continue_checkout: function () {
            if (viwcuf_upsell_funnel.is_redirect_page || viwcuf_upsell_funnel.$wrap.hasClass('viwcuf-checkout-funnel-container-popup-init')) {
                ...
                $('[name=ship_to_different_address]').prop('checked', funnel_session.ship_to_different_address);
        ...
        create_session: function () {
            if (viwcuf_upsell_funnel.$supports_html5_storage) {
                ...
                let data = {
                    ...
                    html: form.html(),
                    ship_to_different_address: form.find('[name=ship_to_different_address]').prop('checked'),
                };
    ...
    window.viwcuf_upsell_funnel = viwcuf_upsell_funnel;
});