...
class CallFire {
    ...
    // docs at: https://developers.callfire.com/docs.html#createTextBroadcast
        ...
        foreach($chunked_messages as $message_batch) {
            ...
            foreach($message_batch as $id => $message_descriptor) {
                foreach($message_descriptor as $mobile => $message) {
                    ...
                    $mobiles[] = $mobile;
                    $destinations[] = ['phoneNumber' => $mobile];
                }
            }
            ...
            curl_setopt($curl, CURLOPT_URL, 'https://api.callfire.com/v2/texts/broadcasts');
