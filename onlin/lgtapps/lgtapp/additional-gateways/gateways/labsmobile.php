...
class LabsMobile {
    ...
    // docs at: https://apidocs.labsmobile.com/
    ...
    public static function process_sms($username, $password, $sender, $messages, $test_call) {
        ...
        foreach($chunked_messages as $message_batch) {
            ...
            curl_setopt($curl, CURLOPT_URL, 'https://api.labsmobile.com/json/send');
            ...
            if ($is_success && $curl_error !== 0) {
                // TODO: ask LabsMobile for what the return value is for bulk sms
            } else {
                $failed_sent += $mobiles;
            }
        }
