...
class RouteSMS {
    // docs at: http://routesms.com/pdf_files/developer/api/SmsPlus_BulkHttp.pdf
    // and http://routesms.com/developers/api/
    ...
    public static function process_sms($username, $password, $sender, $mobile, $message, $test_call){
        ...
        curl_setopt($curl, CURLOPT_URL, 'http://api.rmlconnect.net/bulksms/bulksms?' . $encoded_query);
